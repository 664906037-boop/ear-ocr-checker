...
ระบบรองรับ OCR ภาษาไทยและอังกฤษ โดยใช้ PDF.js แปลงหน้า PDF เป็นภาพ และใช้ Tesseract.js ทำ OCR ใน Browser จึงไม่มีการอัปโหลดเอกสารไปเก็บใน Server ของโปรเจกต์
...
- อังกฤษ: `eng`
- ไทย: `tha`
- ระบบโหลดพร้อมกันด้วย `eng+tha`
- รองรับป้ายกำกับภาษาไทย เช่น หมายเลขตู้, เลขซีล, บุ๊กกิ้ง และหมายเลขจอง
